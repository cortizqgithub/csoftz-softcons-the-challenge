...
/* Description:   Service to manage CountryData information.                      */
...
{
    /// <summary>
    /// Service to manage CountryData information.
    /// </summary>
    public interface ICountryService
    {
        ...
        CountryData Create(CountryData item);
        ...
        /// <param name="item">Information to use</param>
        CountryData Update(CountryData item);
