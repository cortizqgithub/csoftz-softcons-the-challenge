...
/* Description:   MVC Controller to manage Country information.               */
...
{
    /// <summary>
    /// MVC Controller to manage Country information.
    /// </summary>
    ...
    public class CountryController : Controller
    {
        ...
        public IActionResult Create([FromBody] Country item)
        {
            ...
            return CreatedAtRoute("GetCountry", new { id = info.Id }, info);
        }
